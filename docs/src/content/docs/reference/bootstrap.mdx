...
| `write-tack` | Generate/update `.tack/` pins and lock via [tack](https://github.com/manic-systems/tack) |
...
| `nixpkgs` | `https://channels.nixos.org/nixpkgs-unstable/nixexprs.tar.zst` |
