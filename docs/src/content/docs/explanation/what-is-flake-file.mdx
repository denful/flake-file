...
Be it `flake.nix`, `unflake.nix`, `npins`, tack pins.
...
- **Backend-agnostic:** The same module options generate `flake.nix`, `unflake.nix`, `npins/` or tack pins depending on the chosen backend.
